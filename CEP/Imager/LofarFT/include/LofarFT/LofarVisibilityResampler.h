...
#ifndef LOFARFT_LOFARVISIBILITYRESAMPLER_H
#define LOFARFT_LOFARVISIBILITYRESAMPLER_H
...
namespace casacore { //# NAMESPACE CASACORE - BEGIN
  ...
  public: 
    ...
    //    {setConvFunc(cfs);};
    virtual ~LofarVisibilityResampler() {};

    //    VisibilityResampler& operator=(const VisibilityResampler& other);

    void copy(const LofarVisibilityResampler& other)
    {LofarVisibilityResamplerBase::copy(other);}

    virtual LofarVisibilityResamplerBase* clone() 
    {return new LofarVisibilityResampler(*this);}
    ...
    //
    virtual void GridToData(LofarVBStore& vbs,const Array<Complex>& griddedData); 
    //    virtual void GridToData(VBStore& vbs, Array<Complex>& griddedData); 

    virtual void ComputeResiduals(LofarVBStore& vbs);
