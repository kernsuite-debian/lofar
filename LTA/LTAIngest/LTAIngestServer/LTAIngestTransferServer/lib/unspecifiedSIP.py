...
<sip:ltaSip xmlns:sip="http://www.astron.nl/SIP-Lofar"
    ...
    <dataProduct xsi:type="sip:UnspecifiedDataProduct">
        ...
        <storageWriter>%s</storageWriter>
        <storageWriterVersion>%s</storageWriterVersion>
        <processIdentifier>
            <source>SAS</source>
            <identifier>%s</identifier>
...
def makeSIP(Project, ObsId, ArchiveId, ticket, FileName, FileSize, MD5Checksum, Adler32Checksum, Type,
            storageWriter='Unknown', storageWriterVersion='Unknown'):
  if FileName[-3:] == '.MS':
    ...
    fileFormat = 'PULP'
  return genericSIP % (Project, Type, ArchiveId, FileName, ticket, FileSize, MD5Checksum, Adler32Checksum,
                        FileName, fileFormat,
                        storageWriter, storageWriterVersion,
                        ObsId, ObsId, ObsId, ObsId, ObsId)
...
#    print usage
#    exit(1)
  print(makeSIP('test-lofar','12345','43213','VSN3FUNSP98N4F3NLSIWDUALFU3WDF','Bla.FITS',378964322,'md5', 'a32', 'a_type'))
