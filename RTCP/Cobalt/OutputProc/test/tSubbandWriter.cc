...
SUITE(SubbandWriter)
{
  struct OneBeam {
    ...
    OneBeam() {
      ps.add("Observation.VirtualInstrument.stationList",            "[CS001,15*CS002]");
      ps.add("Observation.Dataslots.CS001LBA.RSPBoardList",          "[0]");
      ps.add("Observation.Dataslots.CS001LBA.DataslotList",          "[0]");
      ps.add("Observation.Dataslots.CS002LBA.RSPBoardList",          "[0]");
      ps.add("Observation.Dataslots.CS002LBA.DataslotList",          "[0]");
      ps.add("PIC.Core.CS001LBA.position",                           "[0,0,0]");
      ps.add("PIC.Core.CS001LBA.phaseCenter",                        "[0,0,0]");
      ps.add("PIC.Core.CS002LBA.position",                           "[0,0,0]");
      ps.add("PIC.Core.CS002LBA.phaseCenter",                        "[0,0,0]");
