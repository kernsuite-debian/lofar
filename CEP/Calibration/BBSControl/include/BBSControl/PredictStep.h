//# PredictStep.h: Derived leaf class of the Step composite pattern.
//#
//# Copyright (C) 2006
...
//#
//# $Id: PredictStep.h 14091 2009-09-24 06:11:35Z diepen $
...
namespace LOFAR
{
  namespace BBS
  {
    ...
    // Gamma, 1995).
    // \note Currently, a %PredictStep is in fact identical to a
    // SingleStep. Only the classType() method is overridden.
    class PredictStep : public SingleStep
    {
    public:
      PredictStep(const Step* parent = 0) : 
        SingleStep(parent)
      {
      }

      PredictStep(const string& name, 
