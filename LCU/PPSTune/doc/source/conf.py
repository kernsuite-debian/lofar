...
latex_documents = [
  ('index', 'LOFARPPStuning.tex', 'LOFAR PPS tuning Documentation',
   'M.A. Brentjens', 'manual'),
]
...
man_pages = [
    ('index', 'lofarppstuning', 'LOFAR PPS tuning Documentation',
     ['M.A. Brentjens'], 1)
]
...
texinfo_documents = [
  ('index', 'LOFARPPStuning', 'LOFAR PPS tuning Documentation',
   'M.A. Brentjens', 'LOFARPPStuning', 'One line description of project.',
   'Miscellaneous'),
]
