...
sr.appendLog(21, '')
res = cli.command('python3 verify.py --brd rsp0,rsp1,rsp2,rsp3 --fpga blp0,blp1,blp2,blp3 --rep 1 -v 11 --te tc/hba_client.py --client_access r --client_reg version --data 10')
if res.find('wrong') == -1:
...
sr.appendLog(21, '')
res = cli.command('python3 i2c_spu.py --sub sub0 --rep 1 -v 11')
...
sr.appendLog(21, '')
res = cli.command('python3 i2c_td.py --brd rsp0')
if res.find('FAILED') == -1:
...
sr.appendLog(21, '')
res = cli.command('python3 verify.py --brd rsp0,rsp1,rsp2,rsp3 --rep 1 -v 21 --te tc/bist.py')
if res.find('wrong') == -1:
...
sr.appendLog(21, '')
res = cli.command('python3 verify.py --brd rsp0,rsp1,rsp2,rsp3 --fpga blp0,blp1,blp2,blp3 --pol x,y --rep 1 -v 11 --te tc/prsg.py')
if res.find('wrong') == -1:
