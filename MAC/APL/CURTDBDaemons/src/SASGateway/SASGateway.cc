...

{
    ...
    {
        LOG_ERROR_STR("SASGateway code caught an exception while trying to "
            "read the SAS gateway database name from its configuration file:  "
            << ex.what());
        throw(ex);
    }
    ...
    {
        LOG_ERROR_STR("SASGateway code caught an exception while trying to "
            "read the SAS gateway host name from its configuration file:  "
            << ex.what());
        throw(ex);
    }
    ...
    try
    {
        dbUsername = globalParameterSet()->getString("SASGateway.OTDBusername");
    }
    catch(LOFAR::APSException& ex)
    {
        LOG_ERROR_STR("SASGateway code caught an exception while trying to "
            "read the SAS gateway user name from its configuration file:  "
            << ex.what());
        throw(ex);
    }
    ...
    try
    {
        dbPassword = globalParameterSet()->getString("SASGateway.OTDBpassword");
    }
    catch(LOFAR::APSException& ex)
    {
        LOG_ERROR_STR("SASGateway code caught an exception while trying to "
            "read the SAS gateway password from its configuration file:  "
            << ex.what());
        throw(ex);
    }
    ...
    try
    {
        dbPort = globalParameterSet()->getString("SASGateway.OTDBport");
    }
    catch(LOFAR::APSException& ex)
    {
        LOG_ERROR_STR("SASGateway code caught an exception while trying to "
            "read the SAS gateway port from its configuration file:  "
            << ex.what());
        throw(ex);
    }
