...
//#
//# $Id: FTMachineSplitBeamWStack.cc 31506 2015-04-17 13:42:47Z dijkema $

#include <lofar_config.h>

#include <AWImager2/FTMachineWsplit.h>
...
#include <AWImager2/LofarConvolutionFunction.h>
#include <AWImager2/LofarVisResampler.h>
#include <AWImager2/LofarVBStore.h>
...
void FTMachineWsplit::putSplitWplanesOverlap(const VisBuffer& vb, Int row, Bool dopsf,
                         FTMachine::Type type)
{
  itsCyrilTimer.stop();
