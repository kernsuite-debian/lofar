...
if(NOT DEFINED LOFAR_PACKAGE_LIST_INCLUDED)
  ...
  set(PyServiceSkeleton_SOURCE_DIR ${CMAKE_SOURCE_DIR}/LCS/PyServiceSkeleton)
  ...
  set(PyServiceClientSkeleton_SOURCE_DIR ${CMAKE_SOURCE_DIR}/LCS/PyServiceSkeleton/Client)
  set(PyServiceCommonSkeleton_SOURCE_DIR ${CMAKE_SOURCE_DIR}/LCS/PyServiceSkeleton/Common)
  set(PyServiceServerSkeleton_SOURCE_DIR ${CMAKE_SOURCE_DIR}/LCS/PyServiceSkeleton/Server)
