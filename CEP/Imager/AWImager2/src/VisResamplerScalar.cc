//# VisResamplerScalar.cc: Implementation of the LofarVisResampler class
//#
//# Copyright (C) 2011
...
#include <AWImager2/VisResamplerScalar.h>
...
template
void VisResamplerDiagonal::DataToGridImpl_p(
  Array<DComplex>& grid, 
  VBStore& vbs,
...
//
void VisResamplerDiagonal::GridToData(
  VBStore& vbs,
