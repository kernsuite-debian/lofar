...
static const int DRIVER_VERSION = 260;
...
enum BoardStateT {noBoard,
				  ...
				  swVersionCheck, swVersionChecked,
				  boardReady,
				  boardError};
...
public:
	...
	void setImageSwVersion(int32 boardnr, uint32 swVersion);
...
inline	void TbbSettings::setImageSwVersion(int32 boardnr, uint32 swVersion) { itsBoardInfo[boardnr].imageSwVersion = swVersion; }
