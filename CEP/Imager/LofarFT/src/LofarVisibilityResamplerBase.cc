...
namespace casacore{
  ...
  //-----------------------------------------------------------------------------------
  //
  void LofarVisibilityResamplerBase::copy(const LofarVisibilityResamplerBase& other)
  {
  ...
  //-----------------------------------------------------------------------------------
  //
  LofarVisibilityResamplerBase& LofarVisibilityResamplerBase::operator=(const LofarVisibilityResamplerBase& other)
  {
    copy(other);
    return *this;
  }
  ...
  //-----------------------------------------------------------------------------------
  //
  void LofarVisibilityResamplerBase::sgrid(Int& uvwDim,
