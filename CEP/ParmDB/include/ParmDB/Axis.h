...
namespace BBS {
  ...
  public:
    ...
    // Get all centers, etc.
    // <group>
    const vector<double>& centers() const
      { return itsCenter; }
    const vector<double>& widths() const
      { return itsWidth; }
    const vector<double>& uppers() const
      { return itsUpper; }
    const vector<double>& lowers() const
      { return itsLower; }
    // </group>
...
protected:
    ...
    void setup (const vector<double>& v1, const vector<double>& v2,
                bool asStartEnd);
    ...
    uint        itsId;
    bool        itsIsRegular;
    vector<double> itsCenter;
    vector<double> itsWidth;
    vector<double> itsLower;
    vector<double> itsUpper;
  };
