...
python3 $STATIONTESTROOT/verify.py --brd rsp$rspNr --fp blp$blpNr -v $vb --te $STATIONTESTROOT/tc/hba_server.py --server $oldAddr --server_access uc --server_function gb --server_reg address --data $oldAddr
...
python3 $STATIONTESTROOT/verify.py --brd rsp$rspNr --fp blp$blpNr -v $vb --te $STATIONTESTROOT/tc/hba_server.py --server $newAddr --server_access uc --server_function gb --server_reg address --data $newAddr
...
if [ $answer == "y" ]; then
  python3 $STATIONTESTROOT/verify.py --brd rsp$rspNr --fp blp$blpNr --rep 1 -v $vb --te $STATIONTESTROOT/tc/hba_server.py --server $oldAddr --server_access uc --server_function sb --server_reg address --data $newAddr
