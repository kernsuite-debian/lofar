...
#ifndef LOFARFT_LOFARVISIBILITYRESAMPLERBASE_H
#define LOFARFT_LOFARVISIBILITYRESAMPLERBASE_H
...
namespace casacore { //# NAMESPACE CASACORE - BEGIN
  ...
  public: 
    ...
    virtual ~LofarVisibilityResamplerBase() {};

    LofarVisibilityResamplerBase& operator=(const LofarVisibilityResamplerBase& other);

    virtual LofarVisibilityResamplerBase* clone() = 0;

    void copy(const LofarVisibilityResamplerBase& other);
    ...
    //
    virtual void DataToGrid(Array<DComplex>& griddedData, LofarVBStore& vbs, 
                Matrix<Double>& sumwt, const Bool& dopsf) = 0;

    virtual void DataToGrid(Array<Complex>& griddedData, LofarVBStore& vbs, 
                    Matrix<Double>& sumwt, const Bool& dopsf) = 0;
    ...
    //
    virtual void GridToData(LofarVBStore& vbs,const Array<Complex>& griddedData) = 0; 
    //    virtual void GridToData(VBStore& vbs, Array<Complex>& griddedData); 

    virtual void ComputeResiduals(LofarVBStore& vbs) = 0;
