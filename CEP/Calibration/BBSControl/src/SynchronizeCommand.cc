...
//#
//# $Id: SynchronizeCommand.cc 30631 2014-12-17 10:43:11Z dijkema $
...
namespace LOFAR
{
  namespace BBS 
  {
    ...
    CommandResult SynchronizeCommand::accept(CommandVisitor &visitor) const
    {
    ...
    void SynchronizeCommand::read(const ParameterSet&, const string)
    {
      LOG_TRACE_LIFETIME(TRACE_LEVEL_COND, "");
    }
